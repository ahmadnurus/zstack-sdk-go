...
const (
	...
	accountLoginHostname        = "172.x.x.x" //ZStack Cloud API endpoint IP address
	...
	accessKeyAuthHostname        = "172.x.x.x"
	accessKeyAuthAccessKeyId     = "oSACzWbGbnS4..."
	accessKeyAuthAccessKeySecret = "..."
